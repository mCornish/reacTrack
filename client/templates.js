(function (root, factory) {
    ...
    templatizer["pages"]["admin"] = function tmpl_pages_admin() {
        return '<section class="page admin"><h2>Admin Dashboard</h2><ul class="nav navbar-nav"><li><a data-hook="users-button" class="pointer">Users</a></li><li><a data-hook="gifts-button" class="pointer">Gifts</a></li></ul><div data-hook="viewport" class="viewport"></div><table class="table table-striped"><thead data-hook="users-head" class="temp-hide"><tr><th class="pointer"><span>User</span><span class="arrow-down"></span><span class="arrow-up"></span></th></tr></thead><thead data-hook="gifts-head" class="temp-hide"><tr><th data-hook="header-title" class="pointer"><span>Gift</span><span class="arrow-down"></span><span class="arrow-up"></span></th><th data-hook="header-user" class="pointer"><span>User</span><span class="arrow-down"></span><span class="arrow-up"></span></th><th data-hook="header-created" class="pointer"><span>Created</span><span class="arrow-down"></span><span class="arrow-up"></span></th><th data-hook="header-featured" class="pointer"><span>Featured</span><span class="arrow-down"></span><span class="arrow-up"></span></th></tr></thead><tbody data-hook="table-view"></tbody></table></section>';
    };
