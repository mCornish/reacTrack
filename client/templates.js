(function (root, factory) {
    ...
    templatizer["includes"]["gift"] = function tmpl_includes_gift() {
        return '<div class="grid-list__item js-item"><img data-hook="image" class="grid-list__image"/><div class="grid-list__container"><a data-hook="action-want wantButton"></a><p data-hook="wants"></p></div><a data-hook="edit" class="edit-button">Edit</a><div data-hook="close" class="popup__close">X</div><div data-hook="shade" class="popup__shade"></div><div data-hook="popup" class="popup"><h2 data-hook="title"></h2><p data-hook="time-passed"></p><img data-hook="image" class="popup__image"/><div class="popup__container"><a data-hook="action-want wantButton"></a><p data-hook="wants"></p></div><form data-hook="comment-form"><fieldset data-hook="field-container"></fieldset><div class="buttons"><button data-hook="reset" type="submit" class="btn btn-primary">Comment</button></div></form><ul data-hook="comment-list" class="comments"></ul></div></div>';
    };
